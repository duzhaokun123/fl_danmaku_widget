...
import '../model/danmaku_config.dart';

class BottomDanmaku extends LineDanmaku {
  @override
  Rect? onDraw(
    Canvas canvas,
    double drawWidth,
    ...
    final x = (drawWidth - image.width) / 2;
    final y = drawHeight - danmakuConfig.lineHeight * line - danmakuConfig.marginBottom;
